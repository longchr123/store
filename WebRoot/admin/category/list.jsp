			...
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<!-- varStatus:用来记录循环的状态，count：记录次数，current当前遍历的内容 -->
						<c:forEach var="c" items="${ list }" varStatus="vs">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/adminCategory?method=getById&cid=${c.cid}">
										<img
								...
								<!-- ${c.cid}不加''会报错 -->
								<td align="center" style="HEIGHT: 22px"><a
									href="javascript:void(0)" onclick="deleteC('${c.cid}')"> <img
