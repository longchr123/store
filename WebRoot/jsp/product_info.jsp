	...
	<div class="container">
		<div class="row">
			...
			<div style="margin:0 auto;width:950px;">
				...
				<div class="col-md-6">
				<form id="formId" action="${pageContext.request.contextPath }/cart?method=add" method="post"><!-- 提交表单信息 -->
				<input type="hidden" name="pid" value="${bean.pid }"><!-- 添加 隐藏域 -->
					<div>
					...
					<div
						...
						<div
							...
							购买数量: <input id="quantity" name="count" value="1"
								maxlength="4" size="10" type="text"><!-- 购买数量  -->
						</div>
