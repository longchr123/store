...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<!-- 设置action为post请求 表单提交会存在 乱码，需要过滤器   ${pageContext.request.contextPath}相当于/store-->
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath}/user?method=regist" method="post">
			 <div class="form-group">
			    ...
			    <div class="col-sm-6"><!-- name 为提交的key -->
			 ...
			 <div class="form-group">
			  ...
			  <div class="col-sm-6">
			    <label class="radio-inline"><!-- name 为提交的key,value为提交的value -->
