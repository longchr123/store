...
public class User {
	 ...
	 * DEFAULT NULL, `password` varchar(20) DEFAULT NULL, `name` varchar(20)
	 * DEFAULT NULL, `email` varchar(30) DEFAULT NULL, `telephone` varchar(20)
	 * DEFAULT NULL, `birthday` date DEFAULT NULL, `sex` varchar(10) DEFAULT
	...
	private String sex;
	private Integer state = 0;// 激活状态，1为激活，0 为未激活
	private String code;
